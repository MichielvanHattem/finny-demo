        ...
        try:
            ...
            if "Finny_Year" in df.columns:
                ...
                df["Year_Clean"] = (
                    ...
                    df["Finny_Year"].astype(str).str.split(".").str[0]
        ...
        with st.form("prof"):
            ...
            if st.form_submit_button("Opslaan & Starten"):
                ...
                st.success(
                    ...
                    "Opgeslagen! Je kunt nu naar de chat."
            ...
            with st.chat_message("assistant", avatar=finny_av):
                ...
                with st.spinner("..."):
                    ...
                    if source == "CSV":
                        ...
                        # Nieuw: vraag door als periode of categorie niet is opgegeven
                        ...
                        if missing_year or missing_cat:
                            ...
                            reply_lines = [
                                ...
                                "Om je goed te helpen heb ik nog wat informatie nodig:"
                            ...
                            # Suggest een voorbeeldjaar als hint
                            ...
                            # Skip verdere verwerking voor deze query

                            continue

                        # Context komt uit transacties omdat de gebruiker een CSV-vraag stelt
                        ...
                        # Gebruik de PDF (jaarrekening) voor trendvragen
