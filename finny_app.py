...
if check_password():
    ...
    with st.sidebar:
        ...
        idx = opts.index(cur) if cur in opts else 1 # Default chat if intro missing
    ...
    # --- VIEW: INTRO (TERUG VAN WEGGEWEEST!) ---
    if view == "intro":
        ...
        with st.form("profiel_form"):
            ...
            if st.form_submit_button("Opslaan"):
                ...
                st.success("Profiel opgeslagen! Ga naar de Chat.")
